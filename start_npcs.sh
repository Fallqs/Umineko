...
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u53f3_u4ee3_u5bab_u6731_u5fd7_u9999" python3 scripts/agent_wrapper.py --work-dir roles/右代宫朱志香 --seat-id NPC_右代宫朱志香 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
...
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u53f3_u4ee3_u5bab_u771f_u91cc_u4e9a" python3 scripts/agent_wrapper.py --work-dir roles/右代宫真里亚 --seat-id NPC_右代宫真里亚 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u53f3_u4ee3_u5bab_u79c0_u5409" python3 scripts/agent_wrapper.py --work-dir roles/右代宫秀吉 --seat-id NPC_右代宫秀吉 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
...
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u53f3_u4ee3_u5bab_u8ba9_u6cbb" python3 scripts/agent_wrapper.py --work-dir roles/右代宫让治 --seat-id NPC_右代宫让治 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
...
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u5609_u97f3" python3 scripts/agent_wrapper.py --work-dir roles/嘉音 --seat-id NPC_嘉音 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
...
KIMI_SHARE_DIR="C:\Users\27382\Documents\repo\umi_client\shared\.kimi\NPC__u7eb1_u97f3" python3 scripts/agent_wrapper.py --work-dir roles/纱音 --seat-id NPC_纱音 --orchestrator-host "$HOST" --orchestrator-port "$PORT" --mode npc --yolo --access-token "$TOKEN" &
